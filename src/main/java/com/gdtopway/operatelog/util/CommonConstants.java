...
public class CommonConstants {
    ...
    //附件固定密钥
    public static final String ENCLOSURE_KEY_STARTNAME = "vxL5mI16OXCIwhVPkeUbFPCZTfVtaFMu";
    public static final String ENCLOSURE_KEY_ENDNAME = "Vgg4PQ7RjJuCaPXWLbuvM92S2Zdndvct";
}
